...
var FullCalendar = function(e) {
    ...
    function ht(e, t) {
        return "string" == typeof e ? function(e) {
            ...
            return null
        }(e) : "object" == typeof e && e ? ft(e) : "number" == typeof e ? ft({
            [t || "milliseconds"]: e
        }) : null
    }
    function ft(e) {
    ...
    function Rt(e, t) {
        if (e === t)
            return !0;
        for (let n in e)
            if (Et.call(e, n) && !(n in t))
                return !1;
        for (let n in t)
            if (Et.call(t, n) && e[n] !== t[n])
                return !1;
        return !0
    }
    const xt = /^on[A-Z]/;
    function _t(e, t) {
        let n = [];
        for (let r in e)
            Et.call(e, r) && (r in t || n.push(r));
        for (let r in t)
            Et.call(t, r) && e[r] !== t[r] && n.push(r);
        return n
    }
    function Tt(e, t, n={}) {
        if (e === t)
    ...
    function $t(e, t, n=!1) {
        ...
        r.length > 10 && (null == t ? r = r.replace("Z", "") : 0 !== t && (r = r.replace("Z", tn(t, !0)))),
        r
    }
    function Jt(e) {
    ...
    class hn {
        constructor(e) {
            ...
            for (let i in e)
                i in sn ? (n[i] = e[i],
                r = Math.max(sn[i], r)) : (t[i] = e[i],
                i in on && (r = Math.max(on[i], r)));
    ...
    function Mr(e, t=!1) {
        ...
        return _r() && "rtl" === n.direction ? c.scrollbarLeft = l : c.scrollbarRight = l,
    ...
    function Fr(e) {
        ...
        ,
        U(p(Vr, {}), document.createElement("div")); r.length; )
            r.shift()();
    ...
    class Zr extends D {
        shouldComponentUpdate(e, t) {
            return this.debug && console.log(_t(e, this.props), _t(t, this.state)),
            !Tt(this.props, e, this.propEquality) || !Tt(this.state, t, this.stateEquality)
        }
        safeSetState(e) {
    ...
    class Bi {
        ...
        createMarkerMeta(e) {
            ...
            isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = Yt(e)),
            null !== t && Zt(t) ? {
                marker: t,
                isTimeUnspecified: !1,
                forcedTzo: null
        ...
        formatRange(e, t, n, r={}) {
            return r.isEndExclusive && (t = Ht(t, -1)),
            n.formatRange({
                marker: e,
    ...
    class ji {
        ...
        insertEntryAt(e, t) {
            ...
            -1 === t.lateral ? (Fi(r, t.level, t.levelCoord),
            Fi(n, t.level, [e])) : Fi(n[t.level], t.lateral, e),
    ...
    class Ji extends Xr {
        ...
        render() {
            ...
            return dr() || s.push("fc-liquid-hack"),
            e.children(s, i, r, n)
        }
        componentDidMount() {
    ...
    class gs extends Xr {
        constructor() {
            super(...arguments),
            this.createDayHeaderFormatter = nn(ps)
        }
        render() {
            let {context: e} = this
    ...
    function Ds(e, t, n) {
        let {defs: r} = e
          , i = Dt(e.instances, e=>r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
            range: {
    ...
    function Rs(e, t, n) {
        return !!br(t.validRange, e.range) && xs({
            dateSelection: e
        }, n)
    }
    function xs(e, t) {
    ...
    function _s(e, t, n={}, r) {
        return !(e.eventDrag && !function(e, t, n, r) {
            let i = t.getCurrentData()
              ...
              , a = o.defs
              , l = o.instances
              , c = pi(a, s.isEvent ? e.eventUiBases : {
                "": i.selectionConfig
            });
            r && (c = Dt(c, r));
            ...
            for (let r in l) {
                let o = l[r]
                  ...
                  , p = c[o.defId]
                  , m = a[o.defId];
                if (!Ts(p.constraints, g, d, e.businessHours, t))
                    return !1;
                ...
                for (let e of p.allows) {
                    ...
                    if (i = a ? new li(t,a,l) : new li(t,m),
                    !e(ni(s, t), i))
                        return !1
                }
            }
            ...
            r && (c = r(c));
            if (!Ts(c.constraints, l, i, e.businessHours, t))
                return !1;
            ...
            for (let e in o) {
                ...
                if (yr(l, n.range)) {
                    if (!1 === c.overlap)
                        return !1;
                    if (u && !u(new li(t,s[n.defId],n), null))
                        return !1
                }
            }
    ...
    Js.addStateEquality({
        scrollerClientWidths: Rt,
        scrollerClientHeights: Rt
    });
    class Ks extends Xr {
        constructor() {
            super(...arguments),
    ...
    function Wo(e) {
        let t = "function" == typeof e ? {
          ...
          , {component: n} = t;
        return t.content ? n = Lo(t) : !n || n.prototype instanceof Xr || (n = Lo(Object.assign(Object.assign({}, t), {
            content: n
        }))),
        {
            superType: t.type,
    ...
    const ca = [Po({
        ...
        eventSourceDefs: [{
            ...
            fetch(e, t, n) {
                ...
                Pr(e.eventSource.meta.bind(null, ki(e.range, r)), e=>t({
                    rawEvents: e
                }), n)
            }
        }]
        ...
        propSetHandlers: {
            dateProfile: function(e, t) {
                t.emitter.trigger("datesSet", Object.assign(Object.assign({}, ki(e.activeRange, t.dateEnv)), {
                    view: t.viewApi
                }))
            },
    ...
    function ua(e, t, n) {
        ...
        n.formatRange(r.start, r.end, yn(t.titleFormat || function(e) {
    ...
    class ha {
        ...
        processRawCalendarOptions(e, t) {
            let {locales: n, locale: r} = xn([En, e, t])
              ...
              , g = !1;
            for (let e in d)
                -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || Dn[e] && e in h && Dn[e](h[e], d[e])) ? u[e] = f[e] : l[e] ? (u[e] = l[e](d[e]),
                g = !0) : c[e] = h[e];
        ...
        processRawViewOptions(e, t, n, r, i) {
            let s = xn([En, e.optionDefaults, n, r, e.optionOverrides, i])
              ...
              , u = {};
            for (let e in s)
                s[e] === l[e] || Dn[e] && Dn[e](s[e], l[e]) ? a[e] = c[e] : (s[e] === this.currentCalendarOptionsInput[e] || Dn[e] && Dn[e](s[e], this.currentCalendarOptionsInput[e]) ? e in this.currentCalendarOptionsRefined && (a[e] = this.currentCalendarOptionsRefined[e]) : o[e] ? a[e] = o[e](s[e]) : u[e] = s[e],
                d = !0);
    ...
    class _a extends Zr {
        ...
        render() {
            let e, {props: t} = this, {toolbarConfig: n, options: r} = t, i = this.buildToolbarProps(t.viewSpec, t.dateProfile, t.dateProfileGenerator, t.currentDate, Kr(t.options.now, t.dateEnv), t.viewTitle), s = !1, o = "";
    ...
    function Ma(e) {
        ...
        return new Bi(Object.assign(Object.assign({
    ...
    class Pa {
        ...
        tryStart(e) {
            let t = this.querySubjectEl(e)
              , n = e.target;
            return !(!t || this.handleSelector && !Ie(n, this.handleSelector)) && (this.subjectEl = t,
            this.isDragging = !0,
            this.wasTouchScroll = !1,
            !0)
        }
    ...
    class Va {
        ...
        isWithinClipping(e, t) {
            ...
            for (let e of this.scrollCaches)
                if (!Ga(e.getEventTarget()) && !ir(n, e.clientRect))
                    return !1;
            return !0
        }
    }
    ...
    class Qa {
        ...
        prepareHits() {
            this.offsetTrackers = Dt(this.droppableStore, e=>(e.component.prepareHits(),
            new Va(e.el)))
        }
        releaseHits() {
            ...
            for (let s in n) {
                ...
                if (a && a.isWithinClipping(e, t)) {
                    ...
                    if (l >= 0 && l < u && c >= 0 && c < h) {
                        ...
                        e && br(e.dateProfile.activeRange, e.dateSpan.range) && (!i || e.layer > i.layer) && (e.componentId = s,
                        e.context = o.context,
                        e.rect.left += n,
                        e.rect.right += n,
                        e.rect.top += r,
        ...
        constructor(e) {
            ...
            this.handleHitUpdate = (e,t)=>{
                ...
                if (e) {
                    ...
                    o && (a = ii(n, s.getCurrentData().eventUiBases, o, s),
                    c.mutatedEvents = a,
                    Cs(c, e.dateProfile, s) || (l = !0,
                    o = null,
                    a = null,
                    c.mutatedEvents = {
                        defs: {},
    ...
    var el = Po({
        ...
        , class extends Gi {
            constructor(e) {
                ...
                ,
                this.handlePointerUp = e=>{
                    this.dragSelection && (ti(this.dragSelection, e, this.component.context),
                    this.dragSelection = null)
                }
                ;
                let {component: t} = e
        ...
        , Za, class extends Gi {
            constructor(e) {
                ...
                this.handleHitUpdate = (e,t,n)=>{
                    ...
                    a && (l = ii(i, r.getCurrentData().eventUiBases, a, r),
                    d.mutatedEvents = l,
                    Cs(d, e.dateProfile, r) || (c = !0,
                    a = null,
                    l = null,
    ...
    class hl extends Jr {
        ...
        render() {
            ...
            return p(io, {
                ...
                date: o,
                defaultFormat: ul
            }), !a.isDisabled && (t.showDayNumber || so(i) || t.forceDayTop) ? p("div", {
    ...
    class vl extends Jr {
        ...
        render() {
            let {props: e, state: t, context: n} = this
              ...
              , {singleColPlacements: c, multiColPlacements: d, moreCnts: u, moreMarginTops: h} = gl(vi(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.eventInstanceHeights, t.maxContentHeight, e.cells)
    ...
    class yl extends Jr {
        ...
        render() {
            ...
            return p(hs, {
                unit: "day"
            }, (t,d)=>p(y, null, e.cells.map((t,u)=>p(vl, {
        ...
        prepareHits() {
            this.rowPositions = new Br(this.rootEl,this.rowRefs.collect().map(e=>e.getCellEls()[0]),!1,!0),
        ...
        renderHScrollLayout(e, t, n, r, i, s, o) {
            ...
            return h.push({
                ...
                chunks: [{
                    ...
                    }, e.tableColGroupNode, p("tbody", null, p(Il, {
                        slatMetas: s
                    }))), p("div", {
    ...
    class Hl {
        ...
        computeDateTop(e, t) {
            return t || (t = Lt(e)),
            this.computeTimeTop(ht(e.valueOf() - t.valueOf()))
        }
        computeTimeTop(e) {
            let t, n, {positions: r, dateProfile: i} = this, s = r.els.length, o = (e.milliseconds - vt(i.slotMinTime)) / vt(this.slotDuration);
    ...
    class jl extends Xr {
        ...
        updateSizing() {
            ...
            if (t.onCoords && null !== t.clientWidth) {
                this.rootElRef.current.offsetHeight && t.onCoords(new Hl(new Br(this.rootElRef.current,(n = this.slatElRefs.currentMap,
    ...
    class $l extends Xr {
        ...
        render() {
            ...
            return p(io, {
                ...
                className: "fc-timegrid-now-indicator-container"
            }, this.renderNowIndicator(e.nowIndicatorSegs)), so(n) && p(t, {
                elTag: "div",
    ...
    class ec extends Xr {
        ...
        updateCoords() {
            let {props: e} = this;
            var t;
            e.onColCoords && null !== e.clientWidth && e.onColCoords(new Br(this.rootElRef.current,(t = this.cellElRefs.currentMap,
                ...
                component: class extends Nl {
                    ...
                    render() {
                        let {options: e, dateEnv: t, dateProfileGenerator: n} = this.context
                          ...
                          , f = t=>p(ic, Object.assign({}, o.timed, {
                            dayTableModel: s,
                            dateProfile: i,
                            axis: c,
                            slotDuration: e.slotDuration,
        ...
        render() {
            ...
            return p(Ks, Object.assign({}, e, {
                ...
                if (!1 !== s.displayEventTime) {
                    ...
                    if (a.allDay ? c = !0 : nr(e.eventRange.range) ? e.isStart ? o = Ai(e, t, n, null, null, l.range.start, e.end) : e.isEnd ? o = Ai(e, t, n, null, null, e.start, l.range.end) : c = !0 : o = Ai(e, t, n),
                    c) {
                        let e = {
    ...
    e.Draggable = class {
        constructor(e, t={}) {
            this.handlePointerDown = e=>{
                ...
                t.minDistance = null != n ? n : e.isTouch ? 0 : En.eventDragMinDistance,
